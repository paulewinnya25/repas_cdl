-- Script pour vérifier et corriger l'affichage du nom de l'employé
...
-- 2. Vérifier la structure de la table employee_orders
SELECT 
    column_name, 
    data_type, 
    is_nullable, 
...
-- 5. Ajouter des noms d'employés de test
...
-- 7. Compter les commandes avec et sans noms
SELECT 
    CASE 
