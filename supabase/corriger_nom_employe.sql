-- Script de correction pour le nom de l'employé
-- Exécutez ce script dans votre console Supabase

-- 1. Ajouter la colonne employee_name si elle n'existe pas
DO $$
BEGIN
...
-- 2. Ajouter des noms d'employés de test
